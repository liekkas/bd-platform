...
class LiveUserBehave extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      kpi: kpis[0],
  ...
  _getData(bind, props, dateType = 'D', start = '20150501', end = '20151031') {
    fetch(REST_API_BASE_URL + 'userBehave?type=1&dateType=' + dateType + '&start=' + start + '&end=' + end)
