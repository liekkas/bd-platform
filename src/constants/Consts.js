...
export const Menus = {
  ...
  mapping: {
    tvOverview: { cn: '电视概况', en: 'tvOverview', parent: 'tvOverview' },
    tvUserOverview: { cn: '用户概况', en: 'tvUserOverview', parent: 'tvOverview' },
    tvUserBehave: { cn: '用户行为', en: 'tvUserBehave', parent: 'tvOverview' },
    tvBusinessOverview: { cn: '全业务概况', en: 'tvBusinessOverview', parent: 'tvOverview' },

    liveBroadcast: { cn: '直播业务', en: 'liveBroadcast', parent: 'liveBroadcast' },
    lbUserAna: { cn: '直播用户分析', en: 'lbUserAna', parent: 'liveBroadcast' },
    lbUserOverview: { cn: '直播用户概况', en: 'lbUserOverview', parent: 'liveBroadcast' },
    lbUserBehave: { cn: '直播用户行为', en: 'lbUserBehave', parent: 'liveBroadcast' },
    lbChannelGroup: { cn: '直播频道组分析', en: 'lbChannelGroup', parent: 'liveBroadcast' },
    lbcgUserAna: { cn: '用户分析', en: 'lbcgUserAna', parent: 'lbChannelGroup' },
    lbcgTimeUseAna: { cn: '使用时长分析', en: 'lbcgTimeUseAna', parent: 'lbChannelGroup' },
    lbChannelOrder: { cn: '直播频道排名', en: 'lbChannelOrder', parent: 'liveBroadcast' },
    lbChannelAna: { cn: '直播频道分析', en: 'lbChannelAna', parent: 'liveBroadcast' },
    lbShowsOrder: { cn: '直播节目排名', en: 'lbShowsOrder', parent: 'liveBroadcast' },

    demandBroadcast: { cn: '点播业务', en: 'demandBroadcast', parent: 'demandBroadcast' },
    dbUserAna: { cn: '点播用户分析', en: 'dbUserAna', parent: 'demandBroadcast' },
    dbUserOverview: { cn: '点播用户概况', en: 'dbUserOverview', parent: 'demandBroadcast' },
    dbUserBehave: { cn: '点播用户行为', en: 'dbUserBehave', parent: 'demandBroadcast' },
    dbMediaAssets: { cn: '媒资概况分析', en: 'dbMediaAssets', parent: 'demandBroadcast' },
    dbResAvailAna: { cn: '资源利用率分析', en: 'dbResAvailAna', parent: 'dbMediaAssets' },
    dbShowCenterAna: { cn: '节目集中度分析', en: 'dbShowCenterAna', parent: 'dbMediaAssets' },
    dbShowTypeAna: { cn: '节目类型分析', en: 'dbShowTypeAna', parent: 'demandBroadcast' },
    dbShowTypeUserAna: { cn: '用户分析', en: 'dbShowTypeUserAna', parent: 'dbShowTypeAna' },
    dbShowTypeTimeUseAna: { cn: '点播时长分析', en: 'dbShowTypeTimeUseAna', parent: 'dbShowTypeAna' },
    dbShowsOrder: { cn: '节目排名分析', en: 'dbShowsOrder', parent: 'demandBroadcast' },
    dbMovieOrder: { cn: '电影榜单', en: 'dbMovieOrder', parent: 'dbShowsOrder' },
    dbTVPlayOrder: { cn: '电视剧榜单', en: 'dbTVPlayOrder', parent: 'dbShowsOrder' },
  }
}
